...
| v0.1.4 | `[[wiki-link]]` resolution **index** + `scan --show-graph` (v0.2 Phase 1 staged release per `docs/v0.2-design.md` Q3=B). `LinkIndex` API + section-anchor best-match fallback + Obsidian-ambiguity tolerance. Retrieval loop unchanged. |
